...
export class Initial1747305369644 implements MigrationInterface {
    name = 'Initial1747305369644'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clients" ("clientId" uuid NOT NULL, CONSTRAINT "PK_c8526f623c0beed53b60cb31bf5" PRIMARY KEY ("clientId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "nutritionists" ("nutritionistId" uuid NOT NULL, CONSTRAINT "PK_94a5842c655238e311e9f19d071" PRIMARY KEY ("nutritionistId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "clients" ADD CONSTRAINT "FK_c8526f623c0beed53b60cb31bf5" FOREIGN KEY ("clientId") REFERENCES "users"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "nutritionists" ADD CONSTRAINT "FK_94a5842c655238e311e9f19d071" FOREIGN KEY ("nutritionistId") REFERENCES "users"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "nutritionists" DROP CONSTRAINT "FK_94a5842c655238e311e9f19d071"`);
